                    ...
                    buttons: [
                        {
                            ...
                            action: function () {
                                allScenarios.createService.tour.complete()
                            }
                        }
                    ]
                },
                        ...
                        handler:
                            function () {
                                $('.tutorial-step-create-service-button').on('click', function (event) {
                                    allScenarios.createService.tour.next()
                                });
                            }
                    }
                ]
                ...
                options: {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            text: 'back',
                            action: function () {
                                allScenarios.createService.tour.back()
                            }
                ...
                customFunctionObjects: [
                    {
                        ...
                        handler:
                            function () {
                                $('#config-tab').on('click',  allScenarios.createService.tour.next);
                            }
                    },
                    {
                        event: 'hide',
                        handler:
                            function () {
                                $('#config-tab').unbind("click", allScenarios.createService.tour.next);
                            }
                    }
                ]
            },
